...
import { Crown, Heart, Mail, Lock, Eye, EyeOff } from "lucide-react";
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-elegant flex items-center justify-center p-6">
      ...
      >
        <Card className="w-full max-w-md p-8 bg-card/80 backdrop-blur-md border-border/50 shadow-elegant">
          {/* Header */}
